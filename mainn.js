let isScriptActive = true; // Control whether the script is active
let fullWidth = window.innerWidth; // Store the full window width

// Function to deactivate your script
function deactivateScript() {
    console.log("Script deactivated");
    isScriptActive = false;
}

// Function to reactivate your script if full width is regained
function reactivateScript() {
    if (window.innerWidth >= fullWidth) {
        console.log("Script reactivated");
        isScriptActive = true;
        // You may call your main function here to restart functionality
        yourMainScript(); // Restart main functionality if needed
    }
}

// Function to handle window resizing
function handleResize() {
    if (window.innerWidth < fullWidth && isScriptActive) {
        deactivateScript(); // Deactivate when resized below full width
    } else if (window.innerWidth >= fullWidth && !isScriptActive) {
        reactivateScript(); // Reactivate when full width is regained
    }
}
...
function yourMainScript() {
    if (!isScriptActive) return; // If script is inactive, do nothing
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    // === YOUR 1000 LINES OF CODE END HERE ===
}

// Call your main script initially
yourMainScript();
